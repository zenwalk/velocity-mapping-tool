function [z,A,V,zmin,zmax] = VMT_PlotXSContV3(z,A,V,var,exag,plot_english)
...
% V3 adds ability to plot english units
...
if plot_english
    ...
    %pcolor(V.mcsDist*3.281,V.mcsDepth*3.281,eval(wtp)*convfact)
    ...
    %pcolor(V.mcsDist,V.mcsDepth,eval(wtp))
...
switch var
    case{'streamwise'}
        title(['Streamwise Velocity ' unitlabel])
    case{'transverse'}
        title(['Transverse Velocity ' unitlabel])
    case{'vertical'}
        title(['Vertical Velocity ' unitlabel])
    case{'mag'}
        title(['Velocity Magnitude (Streamwise and Transverse) ' unitlabel])
    case{'primary_zsd'}
        title(['Primary Velocity (Zero Secondary Discharge Definition) ' unitlabel])
    case{'secondary_zsd'}
        title(['Secondary Velocity (Zero Secondary Discharge Definition) ' unitlabel])
    case{'primary_roz'}
        title(['Primary Velocity (Rozovskii Definition) ' unitlabel])
    case{'secondary_roz'}
        title(['Secondary Velocity (Rozovskii Definition) ' unitlabel])   
    case{'primary_roz_x'}
        title(['Primary Velocity (Rozovskii Definition; Downstream Component) ' unitlabel])    
    case{'primary_roz_y'}
        title(['Primary Velocity (Rozovskii Definition; Cross-Stream Component) ' unitlabel])        
    case{'secondary_roz_x'}
        title(['Secondary Velocity (Rozovskii Definition; Downstream Component) ' unitlabel])        
    case{'secondary_roz_y'}
        title(['Secondary Velocity (Rozovskii Definition; Cross-Stream Component) ' unitlabel])         
    case{'backscatter'}
        title('Backscatter Intensity (dB)')
    case{'flowangle'}
        title('Flow Direction (deg)')
%     case{'dirdevp'}
