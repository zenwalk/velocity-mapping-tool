function PVdata = VMT_PlotPlanViewQuiversASCv4(z,A,V,Map,drng,ascale,QuiverSpacing,pvsmwin,pshore,plot_english)
...
%v3 Adds english units option
%v4 adds vector data output option in GUI
