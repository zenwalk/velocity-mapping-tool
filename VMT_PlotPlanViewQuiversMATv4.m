function PVdata = VMT_PlotPlanViewQuiversMATv4(zPathName,zFileName,zf,drng,ascale,QuiverSpacing,pvsmwin,pshore,plot_english)
...
%v4 adds the ability to output data with option in GUI
